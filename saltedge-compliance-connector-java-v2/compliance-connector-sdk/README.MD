...
Set one of the field for the private key (`private_key_name`, `private_key_pem` or `public_key_file_path`).
Set one of the field for the public key (`public_key_name`, `public_key_pem` or `public_key_file_path`).
